...
func (t *taskAPI) GetTaskList(c *gin.Context) {
	...
	c.JSON(http.StatusOK, tasks) // TODO: answer here
}
...
func (t *taskAPI) GetTaskListByCategory(c *gin.Context) {
	...
	tasksCategories, err := t.taskService.GetTaskCategory(categoryID)
	if err != nil {
		c.JSON(http.StatusInternalServerError, model.ErrorResponse{Error: err.Error()})
		return
	}

	c.JSON(http.StatusOK, tasksCategories) // TODO: answer here
}
