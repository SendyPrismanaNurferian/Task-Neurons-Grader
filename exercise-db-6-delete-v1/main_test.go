...
var _ = Describe("Main", Ordered, func() {
	...
	Describe("Delete data in table 'students'", func() {
		It("should have 7 rows", func() {
			err = main.DeleteDataStudents(dbConn)
			if err != nil {
		...
		It("should delete data with status is 'inactive'", func() {
