...
func (s *userService) GetUserTaskCategory() ([]model.UserTaskCategory, error) {
	// Tempat penampung untuk mengambil logika kategori tugas pengguna
	// Anda bisa mengimplementasikan logika untuk mengambil kategori tugas pengguna dari repositori
	// Contoh:
