...
func RunServer(gin *gin.Engine, filebasedDb *filebased.Data) *gin.Engine {
	...
	task := gin.Group("/task")
	{
		...
		task.GET("/get/:id", apiHandler.TaskAPIHandler.GetTaskByID) // TODO: answer here
	...
	category := gin.Group("/category")
	{
		...
		category.GET("/get/:id", apiHandler.CategoryAPIHandler.GetCategoryByID) // TODO: answer here
